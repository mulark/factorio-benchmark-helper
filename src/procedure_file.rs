...
pub fn set_json() {
    ...
    let single_benchmark_set =
        BenchmarkSet{name: String::from("something describing all these maps like test-000041"), pattern: String::from("The regex pattern used to autoselect maps"), mod_groups: vec!(modset), maps: vec!(single_map)};
